...
data={
    ...
    'welcomePrivacyTermsRestrictive':u'Продовжуючи встановлення або запускаючи це програмне забезпечення, я погоджуюся з [Умовами та положеннями](#TERMSANDCONDITIONSLINK), [Особливо важливими положеннями](#RESTRICTIVETERMSANDCONDITIONSLINK) та [Політикою конфіденційності](#PRIVACYPOLICY).',
    ...
    'welcomeTermsAndConditions':u'Вибравши параметр \'{0}\' або \'{1}\', я приймаю #TERMSANDCONDITIONS',
