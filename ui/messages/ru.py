...
data={
    ...
    'welcomePrivacyTermsRestrictive':u'Продолжая установку или запуская это программное обеспечение, я принимаю [Условия и положения](#TERMSANDCONDITIONSLINK), [Особо важные положения](#RESTRICTIVETERMSANDCONDITIONSLINK) и [Политику конфиденциальности](#PRIVACYPOLICY).',
    ...
    'welcomeTermsAndConditions':u'Выбрав опцию \'{0}\' или \'{1}\', я принимаю условия #TERMSANDCONDITIONS',
