...
data={
    ...
    'welcomePrivacyTermsRestrictive':u'En continuar amb la instal·lació o executar aquest programari, accepto els [Termes i condicions](#TERMSANDCONDITIONSLINK), les [Clàusules de particular importància](#RESTRICTIVETERMSANDCONDITIONSLINK) i la [Política de privacitat](#PRIVACYPOLICY).',
