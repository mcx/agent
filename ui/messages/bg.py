...
data={
    ...
    'welcomePrivacyTermsRestrictive':u'Продължавайки с инсталацията или стартирайки този софтуер, приемам [Общите условия](#TERMSANDCONDITIONSLINK), [Клаузите с особена важност](#RESTRICTIVETERMSANDCONDITIONSLINK) и [Политиката за поверителност](#PRIVACYPOLICY).',
    ...
    'welcomeTermsAndConditions':u'Избирайки опцията \'{0}\' или \'{1}\', приемам #TERMSANDCONDITIONS',
