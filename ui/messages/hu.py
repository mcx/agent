...
data={
    ...
    'configureChooseMonitorTrayIconVisibility':u'Szeretné megjeleníteni az ikont a tálcán?',
    ...
    'configureMonitor':u'Monitor konfigurálása',
    ...
    'configureTitle':u'DWAgent - Konfigurálás',
    ...
    'confirmInstall':u'Szeretné telepíteni a DWAgent alkalmazást a következő helyre: \'{0}\'?',
    'confirmUninstall':u'El szeretné távolítani a DWAgent alkalmazást?',
    ...
    'groupName':u'Csoport neve',
    'install':u'Telepítés',
    'installMonitor':u'Monitor telepítése...',
    'installMonitorErr':u'A Monitor telepítése sikertelen volt.',
    ...
    'linuxRootPrivileges':u'A DWAgent alkalmazás telepítéséhez root jogosultságokkal kell rendelkeznie.\nKérjük, futtassa a szkriptet sudo-val vagy root-ként.',
    ...
    'notInstalled':u'A DWAgent alkalmazás nincs telepítve.',
    'ok':u'OK',
    'option':u'Beállítás',
    ...
    'runWithoutInstallationUnexpectedError':u'Váratlan hiba.\nA DWAgent nem tudott elindulni. Ha a probléma továbbra is fennáll, kérjük, töltse le a DWAgent legújabb verzióját, törölje a \'{0}\' mappát, és futtassa újra a DWAgent alkalmazást.',
    ...
    'titleInstall':u'DWAgent - Telepítés',
    'titleUninstall':u'DWAgent - Eltávolítás',
    'toBack':u'visszalépni.',
    'toExit':u'kilépni.',
    'unattendedAccess':u'Felügyelet nélküli\nhozzáférés',
    'unexpectedError':u'Váratlan hiba.\n{0}',
    'uninstallMonitor':u'Monitor eltávolítása...',
    ...
    'welcomePrivacyTermsRestrictive':u'A szoftver telepítésének folytatásával vagy futtatásával elfogadom a [Felhasználási feltételeket](#TERMSANDCONDITIONSLINK), a [Különösen fontos kikötéseket](#RESTRICTIVETERMSANDCONDITIONSLINK) és az [Adatvédelmi irányelveket](#PRIVACYPOLICY).',
