...
data={
    ...
    'welcomePrivacyTermsRestrictive':u'Prin continuarea instalării sau rularea acestui software, accept [Termenii și condițiile](#TERMSANDCONDITIONSLINK), [Clauzele de importanță deosebită](#RESTRICTIVETERMSANDCONDITIONSLINK) și [Politica de confidențialitate](#PRIVACYPOLICY).',
